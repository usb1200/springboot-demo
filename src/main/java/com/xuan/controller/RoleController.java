...
public class RoleController {
     ...
     */
    @RequestMapping("save")
    public ResultUtils save(@RequestBody Role role){
        if (role == null){
            return ResultUtils.error(ErrorCode.CODE_400,"参数为空");
        }
        Integer save = roleService.saveRole(role);
    ...
    public ResultUtils remove(@PathVariable("id") Integer id){
        ...
        Integer remove = roleService.removeRole(id);
    ...
    public ResultUtils findUser(@RequestParam(value = "pageNum",required = false)Integer pageNum,
        ...
        return ResultUtils.success(roleService.findRole(pageNum,pageSize,name));
    }
...
//        ExcelWriter writer = ExcelUtil.getWriter("d:/writeMapTest.xlsx");
        ...
        // 自定义标题别名
//        writer.addHeaderAlias("username","角色名");
...
//        System.out.println(list);
        ...
        for (List<Object> row : list) {
            ...
            role.setFlag(row.get(2).toString());
            roles.add(role);
        }
